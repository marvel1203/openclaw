...
export const pt_BR: TranslationMap = {
  ...
  channels: {
    ...
    healthSub: "Snapshots de status do canal do gateway.",
    statusAndConfig: "Status e configuração do canal.",
    botStatusAndConfig: "Status do bot e configuração do canal.",
    ...
    active: "Ativo",
    probe: "Sondar",
    noSnapshot: "Sem snapshot ainda.",
    feishu: {
      title: "Feishu",
      sub: "Status do bot Feishu e configuração do canal.",
      domain: "Domínio",
      botName: "Nome do bot",
    },
  },
